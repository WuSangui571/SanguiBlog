    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('span', { className: 'h-3.5 w-3.5 rounded-full border border-black/10 bg-[#FF5F56]' }),
                React.createElement('span', { className: 'h-3.5 w-3.5 rounded-full border border-black/10 bg-[#FFBD2E]' }),
                React.createElement('span', { className: 'h-3.5 w-3.5 rounded-full border border-black/10 bg-[#27C93F]' })
            ),
            React.createElement(
                'span',
                { className: `text-[10px] font-black tracking-[0.24em] transition-colors ${feedbackClass}` },
                feedbackText
            ),
            React.createElement(
                'button',
                ...
                React.createElement(copyState === 'success' ? Check : Copy, { size: 14 }),
                buttonText
            )
        ),
        React.createElement(
            'pre',
            {
                className: `m-0 overflow-auto px-5 py-4 ${isDarkMode ? 'bg-[#0B1221] text-gray-100' : 'bg-white text-gray-900'}`
            },
            React.createElement(
                'code',
                { className: `${className || ''} !border-none !bg-transparent !p-0 font-mono text-[13px] leading-6` },
                textContent
            )
        )
    );
